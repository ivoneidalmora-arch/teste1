  ...
  return (
    <Card className="p-4 bg-white border border-slate-100 shadow-sm flex flex-col justify-between h-full min-h-[300px]">
      ...
      <div className="flex items-center justify-between mb-3 border-b border-slate-100 pb-2">
        ...
        <span className="px-2 py-0.5 bg-slate-50 border border-slate-100 text-slate-400 text-[8px] font-black rounded-md uppercase tracking-wider">
      ...
      <div className={cn(
        "mt-3 p-2.5 rounded-xl flex justify-between items-center border",
        isProfit 
